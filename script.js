...
const DOT = STROKE;
const MARGIN = HEIGHT - (BOARDSIZE + 1) * CELL; 
const COLOR_BOARD = "orange";
const COLOR_BORDER = "black";
const COLOR_PLAY2 = "crimson";
const COLOR_PLAY2_LIT = "lightpink";
const COLOR_DOT = "sienna";
const COLOR_PLAY = "blue";
const COLOR_PLAY_LIT = "lightblue";
const COLOR_TIE = "black";
const TEXT_PLAY2 = "Player2";
const TEXT_PLAY2_SML = "P2";
const TEXT_PLAY = "Player";
const TEXT_PLAY_SML = "P1";
...
function drawScores() {
    ...
    drawText(TEXT_PLAY2, WIDTH * 0.75, MARGIN * 0.25, colPlay2, TEXT_SIZE_TOP);
    drawText(scorePlay2, WIDTH * 0.75, MARGIN * 0.6, colPlay2, TEXT_SIZE_TOP * 2);
    ...
    if (timeEnd > 0) {
        ...
        // handle a tie
        if (scorePlay2 == scorePlay) {
            drawText(TEXT_TIE, WIDTH * 0.5, MARGIN * 0.6, COLOR_TIE, TEXT_SIZE_TOP);
        } else {
            let playerWins = scorePlay > scorePlay2;
            let color = playerWins ? COLOR_PLAY : COLOR_PLAY2;
...
function selectSide() {
    ...
    // check for winner
    if (filledSquare) {
        if (scorePlay + scorePlay2 == BOARDSIZE * BOARDSIZE) {
            // game over
            timeEnd = Math.ceil(RESTART_GAME * FPS);
        }
    } else {
